# REDP5350-Getting-Started-with-API-Connect
This repository is used for storing the sample code developed for IBM Redpaper Getting Started with IBM API Connect: Scenarios Guide, REDP5350. The code is provided on an AS-IS basis.
